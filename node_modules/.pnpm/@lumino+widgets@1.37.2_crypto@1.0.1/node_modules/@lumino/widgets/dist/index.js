    ...
    ***************************************************************************** */
    ...
    var AccordionLayout = /** @class */ (function (_super) {
        ...
        AccordionLayout.prototype.attachWidget = function (index, widget) {
            ...
            algorithm.ArrayExt.insert(this._titles, index, title);
            // Add the title node to the parent before the widget.
        ...
        AccordionLayout.prototype.moveWidget = function (fromIndex, toIndex, widget) {
            algorithm.ArrayExt.move(this._titles, fromIndex, toIndex);
    ...
    exports.SplitPanel = /** @class */ (function (_super) {
        ...
        function SplitPanel(options) {
            ...
            _this._handleMoved = new signaling.Signal(_this);
     ...
     */
    exports.AccordionPanel = /** @class */ (function (_super) {
        ...
        AccordionPanel.prototype._onTitleChanged = function (sender) {
            var index = algorithm.ArrayExt.findFirstIndex(this.widgets, function (widget) {
        ...
        AccordionPanel.prototype._evtClick = function (event) {
            ...
            if (target) {
                var index = algorithm.ArrayExt.findFirstIndex(this.titles, function (title) {
    ...
    (function (Private) {
        ...
        function createLayout(options) {
            return (options.layout ||
                new AccordionLayout({
                    renderer: options.renderer || exports.AccordionPanel.defaultRenderer,
                    orientation: options.orientation,
                    alignment: options.alignment,
                    spacing: options.spacing,
    ...
    exports.CommandPalette = /** @class */ (function (_super) {
        ...
        CommandPalette.prototype.onUpdateRequest = function (msg) {
            ...
            if (!results) {
                ...
                this._activeIndex = query
                    ? algorithm.ArrayExt.findFirstIndex(results, Private$a.canActivate)
                    : -1;
            }
        ...
        CommandPalette.prototype._activateNextItem = function () {
            ...
            this._activeIndex = algorithm.ArrayExt.findFirstIndex(this._results, Private$a.canActivate, start, stop);
        ...
        CommandPalette.prototype._activatePreviousItem = function () {
            ...
            this._activeIndex = algorithm.ArrayExt.findLastIndex(this._results, Private$a.canActivate, start, stop);
            // Schedule an update of the items.
            this.update();
        };
        /**
    ...
    (function (CommandPalette) {
        ...
        var Renderer = /** @class */ (function () {
            ...
            Renderer.prototype.formatItemShortcut = function (data) {
                ...
                return kb ? commands.CommandRegistry.formatKeystroke(kb.keys) : null;
            };
            /**
    ...
    exports.Menu = /** @class */ (function (_super) {
        ...
        Menu.prototype.activateNextItem = function () {
            ...
            var start = ai < n - 1 ? ai + 1 : 0;
            var stop = start === 0 ? n - 1 : start - 1;
            this.activeIndex = algorithm.ArrayExt.findFirstIndex(this._items, Private$9.canActivate, start, stop);
        };
        /**
        ...
        Menu.prototype.activatePreviousItem = function () {
            ...
            var start = ai <= 0 ? n - 1 : ai - 1;
            var stop = start === n - 1 ? 0 : start + 1;
            this.activeIndex = algorithm.ArrayExt.findLastIndex(this._items, Private$9.canActivate, start, stop);
        };
        /**
    ...
    (function (Menu) {
        ...
        var Renderer = /** @class */ (function () {
            ...
            Renderer.prototype.renderItem = function (data) {
                ...
                return virtualdom.h.li(__assign({ className: className,
    ...
    var ContextMenu = /** @class */ (function () {
        ...
        function ContextMenu(options) {
            ...
            this.menu = new exports.Menu(others);
    ...
    var DockLayout = /** @class */ (function (_super) {
        ...
        function DockLayout(options) {
            ...
            _this._hiddenMode =
                options.hiddenMode !== undefined
                    ? options.hiddenMode
                    : exports.Widget.HiddenMode.Display;
            return _this;
        }
        /**
         * Dispose of the resources held by the layout.
        ...
        DockLayout.prototype.dispose = function () {
            ...
            algorithm.each(widgets, function (widget) {
                widget.dispose();
            });
        ...
        Object.defineProperty(DockLayout.prototype, "hiddenMode", {
            ...
            set: function (v) {
                ...
                this._hiddenMode = v;
                algorithm.each(this.tabBars(), function (bar) {
        ...
        DockLayout.prototype.init = function () {
            ...
            algorithm.each(this.handles(), function (handle) {
        ...
        DockLayout.prototype._removeWidget = function (widget) {
            ...
            if (tabNode.tabBar.titles.length > 1) {
                ...
                if (this._hiddenMode === exports.Widget.HiddenMode.Scale &&
                    tabNode.tabBar.titles.length == 1) {
                    var existingWidget = tabNode.tabBar.titles[0].owner;
                    existingWidget.hiddenMode = exports.Widget.HiddenMode.Display;
                }
                return;
            }
        ...
        DockLayout.prototype._insertTab = function (widget, ref, refNode, after) {
            ...
            if (this._hiddenMode === exports.Widget.HiddenMode.Scale) {
                if (refNode.tabBar.titles.length === 0) {
                    ...
                    widget.hiddenMode = exports.Widget.HiddenMode.Display;
                }
                    ...
                    existingWidget.hiddenMode = exports.Widget.HiddenMode.Scale;
                }
                else {
                    // For the third and subsequent tabs no special action is needed.
                    widget.hiddenMode = exports.Widget.HiddenMode.Scale;
                }
            }
            else {
        ...
        DockLayout.prototype._insertSplit = function (widget, ref, refNode, orientation, after) {
            ...
            if (splitNode.orientation === orientation) {
                ...
                algorithm.ArrayExt.insert(splitNode.sizers, j_1, Private$6.createSizer(s));
            ...
            algorithm.ArrayExt.insert(childNode.sizers, j, Private$6.createSizer(0.5));
    ...
    (function (Private) {
        ...
        var SplitLayoutNode = /** @class */ (function () {
            ...
            SplitLayoutNode.prototype.createNormalizedSizes = function () {
                ...
                // Normalize the sizes based on the sum.
                if (sum === 0) {
                    algorithm.each(sizes, function (size, i) {
                        sizes[i] = 1 / n;
                    });
                }
                else {
    ...
    exports.DockPanel = /** @class */ (function (_super) {
            ...
            set: function (value) {
                ...
                switch (value) {
                    case 'multiple-document':
                        algorithm.each(layout.tabBars(), function (tabBar) {
                            tabBar.show();
                        });
                        break;
                ...
                messaging.MessageLoop.postMessage(this, Private$5.LayoutModified);
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(DockPanel.prototype, "tabsMovable", {
            ...
            set: function (value) {
                ...
                algorithm.each(this.tabBars(), function (tabbar) {
        ...
        DockPanel.prototype._evtMouseDown = function (event) {
            ...
            // Override the cursor and store the press data.
            var style = window.getComputedStyle(handle);
            var override = dragdrop.Drag.overrideCursor(style.cursor, this._document);
    ...
    (function (DockPanel) {
        ...
        var Renderer = /** @class */ (function () {
            ...
            Renderer.prototype.createTabBar = function (document) {
                var bar = new exports.TabBar({ document: document });
    ...
    var StackedLayout = /** @class */ (function (_super) {
        ...
        StackedLayout.prototype.attachWidget = function (index, widget) {
            ...
            if (this._hiddenMode === exports.Widget.HiddenMode.Scale &&
                ...
                if (this._items.length === 1) {
                    this.widgets[0].hiddenMode = exports.Widget.HiddenMode.Scale;
                }
                widget.hiddenMode = exports.Widget.HiddenMode.Scale;
            }
            else {
        ...
        StackedLayout.prototype.detachWidget = function (index, widget) {
            ...
            if (this._hiddenMode === exports.Widget.HiddenMode.Scale) {
                ...
                if (this._items.length === 1) {
                    this._items[0].widget.hiddenMode = exports.Widget.HiddenMode.Display;
                }
            }
            // Dispose of the layout item.
            item.dispose();
