(function (global, factory) {
    ...
    var candlestick$2 = (function () {
      return ohlcBase$2(d3fcShape.shapeCandlestick(), 'candlestick');
    });
    ...
    var candlestick$1 = (function () {
      return ohlcBase$1(d3fcShape.shapeCandlestick());
    });
    ...
    var candlestick = (function () {
      return ohlcBase(d3fcWebgl.webglSeriesCandlestick());
    });
    ...
    var boxPlot = (function () {
      ...
      d3fcRebind.rebind(boxPlot, draw, 'context', 'lineWidth', 'pixelRatio');
      return boxPlot;
    });

    var ohlc$2 = (function () {
      return ohlcBase$2(d3fcShape.shapeOhlc(), 'ohlc');
    });

    var ohlc$1 = (function () {
      return ohlcBase$1(d3fcShape.shapeOhlc());
    });

    var ohlc = (function () {
      return ohlcBase(d3fcWebgl.webglSeriesOhlc());
    });
    ...
    exports.seriesSvgLine = line$2;
    exports.seriesSvgMulti = multiSeries$2;
    exports.seriesSvgOhlc = ohlc$2;
    exports.seriesSvgPoint = point$2;
