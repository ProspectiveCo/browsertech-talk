(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.fc = global.fc || {}, global.fc, global.d3, global.d3));
    ...
    var areaShader = (function () {
      ...
      vertexShader.appendHeader(area$2.header).appendBody(area$2.body);
    ...
    var ohlcShader = (function () {
      var vertexShader = shaderBuilder(vertexShaderBase);
      var fragmentShader = shaderBuilder(fragmentShaderBase);
      vertexShader.appendHeader(ohlc$2.header).appendBody(ohlc$2.body);
    ...
    var ohlc = (function () {
       ...
       */
      var cornerAttribute = attribute().divisor(0).size(3).type(types.BYTE).data([
      // Main stem
    ...
    var barShader = (function () {
      var vertexShader = shaderBuilder(vertexShaderBase);
      var fragmentShader = shaderBuilder(fragmentShaderBase);
      vertexShader.appendHeader(bar$2.header).appendBody(bar$2.body);
    ...
    var errorBarShader = (function () {
      var vertexShader = shaderBuilder(vertexShaderBase);
      var fragmentShader = shaderBuilder(fragmentShaderBase);
      vertexShader.appendHeader(errorBar$2.header).appendBody(errorBar$2.body);
    ...
    var candlestickShader = (function () {
      var vertexShader = shaderBuilder(vertexShaderBase);
      var fragmentShader = shaderBuilder(fragmentShaderBase);
      vertexShader.appendHeader(candlestick$2.header).appendBody(candlestick$2.body);
    ...
    var boxPlotShader = (function () {
      var vertexShader = shaderBuilder(vertexShaderBase);
      var fragmentShader = shaderBuilder(fragmentShaderBase);
      vertexShader.appendHeader(boxPlot$2.header).appendBody(boxPlot$2.body);
    ...
    var boxPlot = (function () {
       ...
       */
      var cornerAttribute = attribute().divisor(0).size(4).type(types.BYTE).data([
      // Top cap line
    ...
    var fillColor = (function () {
      ...
      d3fcRebind.rebind(fillColor, projectedAttribute, 'data');
      return fillColor;
    });
    ...
    var strokeColor = (function () {
      ...
      d3fcRebind.rebind(strokeColor, projectedAttribute, 'data');
      return strokeColor;
    });
    ...
    exports.webglSeriesArea = area;
    exports.webglSeriesBar = bar;
    exports.webglSeriesBoxPlot = boxPlot;
    exports.webglSeriesCandlestick = candlestick;
    exports.webglSeriesErrorBar = errorBar;
    exports.webglSeriesLine = line;
    exports.webglSeriesOhlc = ohlc;
